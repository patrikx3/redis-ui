...
# 📡 P3X Redis UI can work with huge key sets, is functional and works on the web and desktop (Electron) v2020.4.228
...
Contributors get plus donate license for free for 100 years.
...
[**P3X-REDIS-UI**](https://corifeus.com/redis-ui) Build v2020.4.228
