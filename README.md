...
# 📡 P3X Redis UI can work with huge key sets, is functional and works on the web and desktop (Electron) v2020.10.142
...
* Your port must be not blocked on 7844 and 7845 (one is the redis server, the other is to communicate from the redis server to the electron app)
...
[**P3X-REDIS-UI**](https://corifeus.com/redis-ui) Build v2020.10.142
