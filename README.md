...
# 📡 P3X Redis UI: A highly functional and convenient database GUI that fits in your pocket, accessible on both responsive web and desktop applications v2026.10.100
...
See [**Features**](artifacts/readme/features.md) — Triple GUI (Angular + React + Vue), AI-powered queries, real-time monitoring (Pulse / Profiler / PubSub / Analysis), RediSearch, RedisTimeSeries, ReJSON, RedisBloom, VectorSet, Array (Redis 8.8), Redis 8.x, ACL, and more.
